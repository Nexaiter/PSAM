        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscribeeId = table.Column<int>(type: "int", nullable: false),
                    Id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Subscribers", x => new { x.SubscriberId, x.SubscribeeId });
                    table.ForeignKey(
                        name: "FK_Subscribers_Accounts_SubscribeeId",
                        column: x => x.SubscribeeId,
                        principalTable: "Accounts",
                        principalColumn: "AccountId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Subscribers_Accounts_SubscriberId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Technologies_Accounts_AccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscribers_SubscribeeId",
                table: "Subscribers",
                column: "SubscribeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Technologies_AccountId",
                table: "Technologies",
                column: "AccountId");
        }
